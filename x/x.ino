 ...
 * - VCC: 3.3V del ESP32
 * - GND: GND del ESP32
 * - AOUT: PIN_HUMEDAD_SUELO (GPIO 36)
 * 
 * SENSOR DE PH
 * - VCC: 5V del ESP32
 * - GND: GND del ESP32
 ...
 * - VCC: 5V del ESP32
 * - GND: GND del ESP32
 * - AOUT: PIN_TURBIDEZ (GPIO 35)
 * 
 * SENSOR DE CO2 (MQ-135)
 * - VCC: 5V del ESP32
 * - GND: GND del ESP32
 * - AOUT: PIN_CO2 (GPIO 32)
 * 
 * SENSOR DE VOC (Calidad del aire)
 * - VCC: 5V del ESP32
 * - GND: GND del ESP32
 * - AOUT: PIN_VOC (GPIO 33)
 * 
 * MONITOREO DE BATERÍA
 * - Conectar un divisor de voltaje (dos resistencias en serie)
 * - Punto medio del divisor a PIN_BATERIA (GPIO 25)
 * - Usar resistencias de 10K y 2K para medir hasta 16.5V
 * 
 * NOTAS DE CALIBRACIÓN:
 * - El sensor de pH requiere calibración con soluciones de pH conocido
 * - El sensor de humedad del suelo debe calibrarse en aire (0%) y sumergido en agua (100%)
 * - Los sensores MQ requieren precalentamiento de 24-48 horas para lecturas estables
 * 
 * DIAGRAMA SIMPLIFICADO:
 * 
 * ESP32 ------ DHT22 (Temp/Hum)
 *   |
